...
assert app.INTERFACE_VERSION == "V28.3.9"
...
assert catalog.iloc[0]["Versão da interface"] == "V28.3.9"
assert analysis.iloc[0]["Versão da interface"] == "V28.3.9"
...
print("TESTE DO APP SEM INTERFACE GRÁFICA V28.3.9: OK")
