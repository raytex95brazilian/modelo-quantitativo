...
assert app.INTERFACE_VERSION == "V28.1.5"
...
assert catalog.iloc[0]["Versão da interface"] == "V28.1.5"
assert analysis.iloc[0]["Versão da interface"] == "V28.1.5"

print("TESTE DO APP SEM INTERFACE GRÁFICA V28.1.5: OK")
