...
assert app.INTERFACE_VERSION == "V28.3.16"
...
assert catalog.iloc[0]["Versão da interface"] == "V28.3.16"
assert analysis.iloc[0]["Versão da interface"] == "V28.3.16"
...
print("TESTE DO APP SEM INTERFACE GRÁFICA V28.3.16: OK")
