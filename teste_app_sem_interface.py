...
assert app.INTERFACE_VERSION == "V28.3.10"
...
assert catalog.iloc[0]["Versão da interface"] == "V28.3.10"
assert analysis.iloc[0]["Versão da interface"] == "V28.3.10"
...
print("TESTE DO APP SEM INTERFACE GRÁFICA V28.3.10: OK")
