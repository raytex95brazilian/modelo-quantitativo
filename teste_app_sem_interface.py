...
assert app.INTERFACE_VERSION == "V28.2.0"
...
assert catalog.iloc[0]["Versão da interface"] == "V28.2.0"
assert analysis.iloc[0]["Versão da interface"] == "V28.2.0"
...
print("TESTE DO APP SEM INTERFACE GRÁFICA V28.2.0: OK")
